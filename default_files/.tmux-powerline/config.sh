...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/david.jefts/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/david.jefts/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/david.jefts/.now_playing.log"
...
# weather.sh {
	...
	#   rm "/tmp/tmux-powerline_david.jefts/tmux-powerline/weather_cache_data.txt"
